...
namespace Custom
{
    ...
    public class OpenGFGenerator
    {
        ...
        public OpenGFGenerator(Plot3D plot, int attractorsCount, int threshold)
        {
            this.plot = plot;
            width = plot.width;
            depth = plot.depth;
            scale = plot.scale;
            openGFMap = new int[width, depth];
        ...
        public OpenGFGenerator(Plot3D plot, int attractorsCount) :this (plot, attractorsCount, 50) { }
        ...
        public void GenerateMap(int threshold)
        {
            ...
            for (int x = 0; x < width; x++)
            {
                for (int z = 0; z < depth; z++)
                {
                    ...
                    openGFMap[x, z] = openGFMap[x, z] = newValue >= threshold ? 1 : 0;
                }
            }
